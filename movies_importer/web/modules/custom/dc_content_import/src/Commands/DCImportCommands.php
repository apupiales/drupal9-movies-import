          ...
          if (empty($result)) {
            ...
            if ($full_movie_data) {
              ...
              if (!empty($full_movie_data['poster_path'])) {
                ...
                $poster_full_url = 'https://www.themoviedb.org/t/p/original' . $full_movie_data['poster_path'] . '?api_key=' . $this->DCMovieTools->getApiKey();
                $this->manageAPIRequestCount($api_request_count);
          ...
          if (empty($result)) {
            ...
            if ($full_actor_data) {
              ...
              if (!empty($full_actor_data['profile_path'])) {
                ...
                $photo_full_url = 'https://www.themoviedb.org/t/p/original' . $full_actor_data['profile_path'] . '?api_key=' . $this->DCMovieTools->getApiKey();
                $this->manageAPIRequestCount($api_request_count);
              ...
              if (!empty($images['profiles'])) {
                ...
                foreach ($images['profiles'] as $image) {
                  ...
                  $photo_full_url = 'https://www.themoviedb.org/t/p/original' . $image['file_path'] . '?api_key=' . $this->DCMovieTools->getApiKey();
                  $this->manageAPIRequestCount($api_request_count);
                  $fid = $this->DCMovieTools->createFileByPath($photo_full_url, $photo_destination);
              ...
              if (!empty($movie_credits['cast'])) {
                ...
                if (!empty($movies)) {
                  ...
                  $movies = $node_storage->loadMultiple($result);
